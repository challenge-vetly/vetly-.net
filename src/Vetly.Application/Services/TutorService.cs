...
/// <summary>Serviço de tutores. Gerencia cadastro e consentimentos LGPD.</summary>
public class TutorService : ITutorService
{
    ...
    public async Task<TutorDto> CriarAsync(CriarTutorDto dto)
    {
        ...
        if (existente is not null)
            throw new BusinessRuleException("TUTOR-001", $"E-mail '{dto.Email}' já está cadastrado.");
