...
{
    /// <summary>Agenda um lembrete para um responsavel sobre evento do animal.</summary>
    Task<LembreteAgendado> AgendarLembreteAsync(Guid animalId, Guid responsavelId, TipoLembrete tipo, DateTime dataEvento);
